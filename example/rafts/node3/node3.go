...
func main() {
	...
	pbRafts.NewRaft("debug", "./logs/node3", &pbRafts.Node{Id: "3", Url: "127.0.0.1:19879"}, []*pbRafts.Node{
...
func httpListener() {
	...
	rivet.Log().Init(env.GetEnvDefault(env.LogPath, "./logs/node3"), "node1", &log.Config{
