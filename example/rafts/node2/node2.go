...
func main() {
	...
	pbRafts.NewRaft("debug", "./logs/node2", &pbRafts.Node{Id: "2", Url: "127.0.0.1:19878"}, []*pbRafts.Node{
...
func httpListener() {
	...
	rivet.Log().Init(env.GetEnvDefault(env.LogPath, "./logs/node2"), "node1", &log.Config{
